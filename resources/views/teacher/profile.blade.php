    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <a href="{{ route('teacher.courses') }}" class="flex items-center p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors">
                        ...
                        <a href="{{ route('teacher.quizzes') }}" class="flex items-center p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors">
                        ...
                        <a href="{{ route('teacher.analytics') }}" class="flex items-center p-3 bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors">
