    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl shadow-lg p-6 mb-8 text-white">
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="mt-4 md:mt-0 flex space-x-3">
                <a href="{{ route('teacher.courses.create') }}" class="bg-white text-blue-700 hover:bg-blue-50 font-bold py-2 px-4 rounded-lg shadow-md transition duration-200 flex items-center">
                    <i class="fas fa-plus mr-2"></i> Create Course
                </a>
                <a href="{{ route('teacher.quizzes.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-200 flex items-center">
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white">
                        {{ count($recentQuizResults) > 0 ? round($recentQuizResults->avg('score')) : 0 }}%
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <a href="{{ route('teacher.courses') }}" class="flex items-center p-4 bg-blue-50 dark:bg-gray-700 rounded-lg hover:bg-blue-100 dark:hover:bg-gray-600 transition">
                            <div class="p-3 rounded-full bg-blue-100 dark:bg-blue-900 mr-4">
                        ...
                        <a href="{{ route('teacher.courses.create') }}" class="flex items-center p-4 bg-blue-50 dark:bg-gray-700 rounded-lg hover:bg-blue-100 dark:hover:bg-gray-600 transition">
                            <div class="p-3 rounded-full bg-blue-100 dark:bg-blue-900 mr-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <a href="{{ route('teacher.quizzes') }}" class="flex items-center p-4 bg-green-50 dark:bg-gray-700 rounded-lg hover:bg-green-100 dark:hover:bg-gray-600 transition">
                            <div class="p-3 rounded-full bg-green-100 dark:bg-green-900 mr-4">
                        ...
                        <a href="{{ route('teacher.quizzes.create') }}" class="flex items-center p-4 bg-green-50 dark:bg-gray-700 rounded-lg hover:bg-green-100 dark:hover:bg-gray-600 transition">
                            <div class="p-3 rounded-full bg-green-100 dark:bg-green-900 mr-4">
                        ...
                        <a href="{{ route('teacher.courses') }}" class="flex items-center p-4 bg-green-50 dark:bg-gray-700 rounded-lg hover:bg-green-100 dark:hover:bg-gray-600 transition">
                            <div class="p-3 rounded-full bg-green-100 dark:bg-green-900 mr-4">
                        ...
                        <a href="{{ route('face.exam.monitoring') }}" class="flex items-center p-4 bg-green-50 dark:bg-gray-700 rounded-lg hover:bg-green-100 dark:hover:bg-gray-600 transition">
                            <div class="p-3 rounded-full bg-green-100 dark:bg-green-900 mr-4">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <a href="{{ route('teacher.analytics') }}" class="flex items-center p-4 bg-purple-50 dark:bg-gray-700 rounded-lg hover:bg-purple-100 dark:hover:bg-gray-600 transition">
                            <div class="p-3 rounded-full bg-purple-100 dark:bg-purple-900 mr-4">
                                ...
                                <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <div class="flex-shrink-0 mr-3">
                                        <div class="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-600 flex items-center justify-center">
                                            <span class="text-gray-700 dark:text-gray-300 font-bold">{{ substr($result->student_name, 0, 1) }}</span>
                                        </div>
                                    </div>
                                    <div class="flex-grow">
                                        <div class="flex justify-between items-center">
                                            <h3 class="font-medium text-gray-800 dark:text-white">{{ $result->student_name }}</h3>
                                        ...
                                        <div class="flex justify-between text-sm">
                                            <p class="text-gray-600 dark:text-gray-400">{{ $result->quiz_name }}</p>
                                            <p class="text-gray-500 dark:text-gray-400">{{ $result->created_at->diffForHumans() }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
