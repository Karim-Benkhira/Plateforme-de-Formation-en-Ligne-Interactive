        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h2 class="mb-0">{{ __('Add New Module') }}</h2>
                </div>
                <div class="card-body">
                    <form action="{{ route('teacher.modules.store') }}" method="POST">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('teacher.courses.edit', request('course_id')) }}" class="btn btn-secondary">
                                <i class="fas fa-times me-2"></i>{{ __('Cancel') }}
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>{{ __('Create Module') }}
                            </button>
                        </div>
                    </form>
                </div>
