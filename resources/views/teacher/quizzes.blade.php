...
<div class="welcome-banner bg-gradient-to-r from-primary-600 to-secondary-600 rounded-xl shadow-lg p-6 mb-8">
    <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="mt-4 md:mt-0">
            <a href="{{ route('teacher.quizzes.create') }}" class="btn-white">
                        ...
                        @foreach($quizzes as $quiz)
                            <tr class="hover:bg-gray-700 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-white">{{ $quiz->name }}</div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-200">{{ $quiz->course->title }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-3">
                                        <a href="{{ route('teacher.quizQuestions', $quiz->id) }}" class="action-icon primary" title="View Questions">
                                            <i class="fas fa-list-ul"></i>
                                        </a>
                                        <a href="{{ route('teacher.quizzes.edit', $quiz->id) }}" class="action-icon primary" title="Edit Quiz">
