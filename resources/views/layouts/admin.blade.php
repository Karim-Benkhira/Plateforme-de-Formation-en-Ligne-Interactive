...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - BrightPath</title>
        ...
        <aside class="dashboard-sidebar" :class="{ 'collapsed': !sidebarOpen }">
            ...
            <div class="mt-6">
                <nav>
                    ...
                    <a href="{{ route('admin.reclamations') }}" class="sidebar-link {{ request()->routeIs('admin.reclamations*') ? 'active' : '' }}">
            ...
            <header class="bg-gray-800 shadow-md">
                <div class="flex items-center justify-between px-6 py-4">
                    <div class="flex items-center">
                        <h1 class="text-xl font-semibold text-white">@yield('title', 'Admin Dashboard')</h1>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-56 bg-gray-800 rounded-lg shadow-xl py-2 border border-gray-700 z-50">
                                ...
                                <a href="{{ route('profile.edit') }}" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors flex items-center">
