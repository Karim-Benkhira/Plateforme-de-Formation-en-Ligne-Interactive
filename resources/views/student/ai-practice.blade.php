...
@section('title', 'AI Practice Questions')
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="stats-card">
                ...
                <div>
                    ...
                    <p class="stats-value">{{ $enrolledCourses->count() }}</p>
                </div>
            </div>
            <div class="stats-card">
                ...
                <div>
                    ...
                    <p class="stats-value">{{ $coursesWithContent->count() }}</p>
                </div>
            </div>
            <div class="stats-card">
                ...
                <div>
                    ...
                    <p class="stats-value">{{ $user->practiceQuestions()->count() ?? 0 }}</p>
                </div>
            </div>
        </div>
        ...
        @foreach($coursesByCategory as $categoryName => $courses)
            <div class="section-card mb-8">
                <div class="section-header">
                    ...
                    <span class="ml-2 text-sm text-gray-500">({{ $courses->count() }} courses)</span>
                </div>
                        ...
                        @foreach($courses as $course)
                            <div class="course-card">
                                <div class="course-card-header">
                                    ...
                                    @endif
                                    <div class="course-level-badge {{ $course->level }}">
                                ...
                                <div class="course-card-content">
                                    ...
                                    <div class="course-info">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <span>{{ $course->sections->sum('estimated_duration') ?? 'N/A' }} min</span>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="section-card">
            ...
            <div class="section-content">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <a href="{{ route('student.ai.quiz', $coursesWithContent->first()->id) }}?difficulty=easy" 
                    ...
                    <a href="{{ route('student.ai.quiz', $coursesWithContent->first()->id) }}?difficulty=medium" 
                    ...
                    <a href="{{ route('student.ai.quiz', $coursesWithContent->first()->id) }}?difficulty=hard" 
                    ...
                    <a href="{{ route('student.ai.quiz', $coursesWithContent->random()->id) }}?question_type=mixed" 
