            ...
            <div class="upload-card p-8 mb-8 fade-in">
                <div class="text-center">
                    ...
                    <p class="text-gray-300 mb-6">
                        Your identity verification photo was uploaded on {{ $existingPhoto->created_at->format('M d, Y \a\t g:i A') }}
                    </p>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        ...
                        <form action="{{ route('face-verification.photo.delete') }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
