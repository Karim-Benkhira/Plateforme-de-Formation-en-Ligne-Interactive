    ...
    <div class="grid md:grid-cols-4 gap-8 mb-8">
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li>
            <a href="{{ route('login') }}" class="text-gray-300 hover:text-blue-400 transition-colors duration-300">
              <i class="fas fa-chevron-right text-xs text-blue-500 mr-2"></i>
              Login
            </a>
          </li>
          <li>
            <a href="{{ route('register') }}" class="text-gray-300 hover:text-blue-400 transition-colors duration-300">
              <i class="fas fa-chevron-right text-xs text-blue-500 mr-2"></i>
              Register
            </a>
          </li>
