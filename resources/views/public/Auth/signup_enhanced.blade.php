        ...
        <div class="glass-effect rounded-xl shadow-2xl overflow-hidden border border-gray-700 animate-fade-in">
                    ...
                    <div>
                        ...
                        <div class="relative input-field">
                            ...
                            <input
                                ...
                                class="w-full pl-10 pr-3 py-3 bg-gray-700/70 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300 @error('name') border-red-500 @enderror"
                                required
                            >
                        </div>
                        @error('name')
            ...
            <div class="py-4 px-8 bg-gray-900/80 border-t border-gray-700">
                <p class="text-center text-gray-400">
                    ...
                    <a href="{{ route('login') }}" class="text-blue-400 hover:text-blue-300 font-medium transition-all duration-300">
                        Sign in
                    </a>
                </p>
            </div>
