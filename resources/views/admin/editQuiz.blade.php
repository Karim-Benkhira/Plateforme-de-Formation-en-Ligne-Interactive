        ...
        <form action="{{ route('admin.updateQuiz', $quiz->id) }}" method="POST" class="space-y-8">
            ...
            <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700/50">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-900/50 p-4 rounded-lg border border-gray-700/50">
                        <div class="flex items-center">
                            <input type="checkbox" name="requires_face_verification" id="requires_face_verification" value="1" class="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-700 bg-gray-700 rounded" {{ old('requires_face_verification', $quiz->requires_face_verification) ? 'checked' : '' }}>
