...
<div class="bg-gradient-to-r from-blue-900 via-primary-800 to-secondary-900 rounded-xl shadow-2xl p-6 mb-8 border border-blue-700/30 relative overflow-hidden">
    ...
    <div class="relative flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="mt-4 md:mt-0">
            <a href="{{ route('admin.quizzes') }}" class="bg-gray-800 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded-lg shadow-lg border border-gray-700 transition duration-200 inline-flex items-center group">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_published" id="is_published" value="1" class="h-5 w-5 text-purple-600 focus:ring-purple-500 border-gray-700 bg-gray-700 rounded" {{ old('is_published') ? 'checked' : '' }}>
                    ...
                    <div class="bg-gray-800/50 p-4 rounded-lg border border-gray-700/50">
                        <div class="flex items-center">
                            <input type="checkbox" name="requires_face_verification" id="requires_face_verification" value="1" class="h-5 w-5 text-purple-600 focus:ring-purple-500 border-gray-700 bg-gray-700 rounded" {{ old('requires_face_verification') ? 'checked' : '' }}>
