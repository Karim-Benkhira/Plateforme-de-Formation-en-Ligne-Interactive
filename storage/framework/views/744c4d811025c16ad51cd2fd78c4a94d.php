...
<div class="bg-gradient-to-r from-blue-900 via-primary-800 to-secondary-900 rounded-xl shadow-2xl p-6 mb-8 border border-blue-700/30 relative overflow-hidden">
    ...
    <div class="relative flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="mt-4 md:mt-0">
            <a href="<?php echo e(route('admin.categories')); ?>" class="group bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 font-semibold py-3 px-5 rounded-lg shadow-lg transition-all duration-300 inline-flex items-center hover:shadow-blue-500/20 hover:shadow-xl">
    ...
    <div class="relative">
        ...
        <form action="<?php echo e(route('admin.storeCategory')); ?>" method="POST" class="space-y-8">
            ...
            <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700/50">
                ...
                <div class="grid grid-cols-4 md:grid-cols-8 gap-4 p-4 bg-gray-900/70 rounded-xl border border-gray-700/50">
                    ...
                    <div>
                        ...
                        <label for="icon-<?php echo e($icon); ?>" class="radio-card flex flex-col items-center justify-center p-3 rounded-lg cursor-pointer bg-gray-800 hover:bg-gray-700 peer-checked:bg-gradient-to-br peer-checked:from-green-900/80 peer-checked:to-blue-900/80 peer-checked:text-green-300 peer-checked:border-green-500/50 peer-checked:shadow-lg transition-all duration-300 border border-gray-700 hover:border-gray-600">
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-4 pt-4 border-t border-gray-700/50">
                <a href="<?php echo e(route('admin.categories')); ?>" class="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium rounded-lg transition-all duration-300 flex items-center justify-center">
