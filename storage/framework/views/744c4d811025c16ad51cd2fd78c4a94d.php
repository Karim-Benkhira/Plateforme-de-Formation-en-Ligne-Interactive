...
<div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl shadow-lg p-6 mb-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="mt-4 md:mt-0">
            <a href="<?php echo e(route('admin.categories')); ?>" class="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded-lg shadow transition duration-200 inline-flex items-center">
    ...
    <form action="<?php echo e(route('admin.storeCategory')); ?>" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <div class="grid grid-cols-4 md:grid-cols-8 gap-3 p-3 bg-gray-800 rounded-lg">
                <?php $__currentLoopData = ['book', 'code', 'laptop', 'calculator', 'flask', 'language', 'music', 'palette']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div>
                    ...
                    <label for="icon-<?php echo e($icon); ?>" class="flex flex-col items-center justify-center p-2 rounded-lg cursor-pointer bg-gray-700 peer-checked:bg-green-900 peer-checked:text-green-300 hover:bg-gray-600 transition-colors">
                        <i class="fas fa-<?php echo e($icon); ?> text-xl"></i>
                        <span class="text-xs mt-1 capitalize"><?php echo e($icon); ?></span>
                    </label>
                </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-5 md:grid-cols-10 gap-3 p-3 bg-gray-800 rounded-lg">
                ...
                <div>
                    ...
                    <label for="color-<?php echo e($color); ?>" class="block w-full h-10 rounded-lg cursor-pointer bg-<?php echo e($color); ?>-500 peer-checked:ring-2 peer-checked:ring-white hover:opacity-90 transition-opacity"></label>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        ...
        <div class="flex justify-end space-x-4 pt-4">
            <a href="<?php echo e(route('admin.categories')); ?>" class="px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-lg transition duration-200">
                Cancel
            </a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/admin/createCategory.blade.php ENDPATH**/ ?>