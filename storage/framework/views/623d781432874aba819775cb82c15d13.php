        ...
        <header class="dashboard-header bg-gray-800 rounded-lg shadow-lg mb-6">
            <div class="container mx-auto px-4">
                <div class="flex justify-between items-center py-3">
                    ...
                    <nav class="dashboard-nav hidden md:flex items-center space-x-6">
                        ...
                        <a href="<?php echo e(route('teacher.course-builder.index')); ?>" class="dashboard-nav-link <?php echo e(request()->routeIs('teacher.course-builder*') ? 'active' : ''); ?>">Course Builder</a>
                        ...
                        <a href="<?php echo e(route('teacher.enrollments.index')); ?>" class="dashboard-nav-link <?php echo e(request()->routeIs('teacher.enrollments*') ? 'active' : ''); ?> relative">
                            Enrollments
                    ...
                    <div class="flex items-center">
                        <div class="relative" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center space-x-2 focus:outline-none">
                                ...
                                <span class="text-gray-300 hidden md:inline-block font-medium"><?php echo e(Auth::user()->username); ?></span>
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-56 bg-gray-800 rounded-lg shadow-xl py-2 border border-gray-700 z-50">
                                ...
                                <a href="<?php echo e(route('teacher.profile')); ?>" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                    </svg>
                                    My Profile
                                </a>
                                <a href="<?php echo e(route('teacher.profile')); ?>#password" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors flex items-center">
            ...
            <div class="md:hidden hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1">
                    ...
                    <a href="<?php echo e(route('teacher.course-builder.index')); ?>" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700">Course Builder</a>
                    ...
                    <a href="<?php echo e(route('teacher.enrollments.index')); ?>" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700">Enrollments</a>
...
<?php /**PATH /var/www/resources/views/layouts/teacher.blade.php ENDPATH**/ ?>