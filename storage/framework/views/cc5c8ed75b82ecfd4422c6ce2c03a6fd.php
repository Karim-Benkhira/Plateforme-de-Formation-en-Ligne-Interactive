...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
    <div class="stats-card">
        ...
        <div>
            ...
            <p class="stats-value"><?php echo e($coursesCount ?? 0); ?></p>
        </div>
    </div>
    ...
    <div class="stats-card">
        ...
        <div>
            ...
            <p class="stats-value"><?php echo e($quizzesCount ?? 0); ?></p>
        </div>
    </div>
    ...
    <div class="stats-card">
        ...
        <div>
            ...
            <p class="stats-value"><?php echo e($studentCount ?? 0); ?></p>
        </div>
    </div>
    ...
    <div class="stats-card">
        ...
        <div>
            ...
            <p class="stats-value"><?php echo e(count($recentQuizResults ?? []) > 0 ? round($recentQuizResults->avg('score')) : 0); ?>%</p>
        </div>
    </div>
</div>
        ...
        <div class="section-card">
            ...
            <div class="section-content">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <a href="<?php echo e(route('face.exam.monitoring')); ?>" class="action-card">
                        <div class="action-icon secondary">
                            ...
                            <div class="flex items-center p-3 bg-gray-800 rounded-lg">
                                <div class="flex-shrink-0 mr-3">
                                    <div class="w-10 h-10 rounded-full bg-primary-900 flex items-center justify-center">
                                        <span class="text-primary-300 font-bold"><?php echo e(substr($result->student_name, 0, 1)); ?></span>
                                    </div>
                                </div>
                                <div class="flex-grow">
                                    <div class="flex justify-between items-center">
                                        <h3 class="font-medium text-white"><?php echo e($result->student_name); ?></h3>
                                        <span class="px-2 py-1 text-xs font-semibold rounded-full
                                            <?php echo e($result->score >= 70 ? 'bg-primary-900 text-primary-300' : ($result->score >= 50 ? 'bg-secondary-900 text-secondary-300' : 'bg-red-900 text-red-300')); ?>">
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/teacher/dashboard.blade.php ENDPATH**/ ?>