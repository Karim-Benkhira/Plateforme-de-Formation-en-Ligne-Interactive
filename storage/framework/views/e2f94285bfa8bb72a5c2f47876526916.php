...
<div class="flex items-center mb-8">
    <a href="<?php echo e(route('teacher.courses')); ?>" class="mr-4 text-blue-400 hover:text-blue-300 transition-colors duration-200 flex items-center">
        ...
        <div class="bg-gray-800 rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-6">
                <div class="flex justify-between items-center mb-4">
                    <div>
                        <span class="text-sm text-gray-400">Category: <?php echo e($course->category ? $course->category->name : 'Uncategorized'); ?></span>
                        <p class="text-sm text-gray-400 mt-1">Created: <?php echo e($course->created_at->format('M d, Y')); ?></p>
                    </div>
                ...
                <p class="text-gray-300 mb-6"><?php echo e($course->description); ?></p>
    ...
    <div>
        ...
        <div class="bg-gray-800 rounded-lg shadow-md p-6 mb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="bg-blue-900/20 p-4 rounded-lg">
                    ...
                    <p class="text-2xl font-bold text-white"><?php echo e($quizzes->count()); ?></p>
                </div>
                <div class="bg-green-900/20 p-4 rounded-lg">
                    <p class="text-sm text-green-400">Students</p>
                    <p class="text-2xl font-bold text-white"><?php echo e($course->students_count ?? 0); ?></p>
                </div>
            </div>
            <div class="mt-4">
                <a href="<?php echo e(route('teacher.course-analytics', $course->id)); ?>" class="text-blue-400 hover:text-blue-300 inline-flex items-center">
        ...
        <div class="bg-gray-800 rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="<?php echo e(route('teacher.quizzes.create')); ?>" class="text-blue-400 hover:text-blue-300">
                    ...
                    <?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="border border-gray-700 rounded-lg p-4">
                            <div class="flex justify-between items-start">
                                <div>
                                    <h3 class="font-medium text-white"><?php echo e($quiz->name); ?></h3>
                                    <p class="text-sm text-gray-400"><?php echo e($quiz->questions->count()); ?> questions</p>
                                </div>
                            ...
                            <div class="mt-3 flex space-x-2">
                                <a href="<?php echo e(route('teacher.quizQuestions', $quiz->id)); ?>" class="text-sm text-blue-400 hover:text-blue-300">
                                    <i class="fas fa-list-ul mr-1"></i> Questions
                                </a>
                                <a href="<?php echo e(route('teacher.quizzes.edit', $quiz->id)); ?>" class="text-sm text-green-400 hover:text-green-300">
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/teacher/courseDetails-updated.blade.php ENDPATH**/ ?>