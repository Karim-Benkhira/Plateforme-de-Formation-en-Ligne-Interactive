...
<div class="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl shadow-lg p-6 mb-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="mt-4 md:mt-0">
            <a href="<?php echo e(route('admin.createQuiz')); ?>" class="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded-lg shadow transition duration-200 inline-flex items-center">
...
<div class="data-card">
                ...
                <tr class="quiz-row">
                    <td>
                        <div class="flex items-center">
                            ...
                            <span class="font-medium"><?php echo e($quiz->name); ?></span>
                        </div>
                    </td>
                    <td>
                        <a href="<?php echo e(route('admin.showCourse', $quiz->course->id)); ?>" class="hover:text-blue-400 transition-colors">
                    ...
                    <td>
                        <span class="text-gray-400"><?php echo e($quiz->created_at->format('M d, Y')); ?></span>
                    </td>
                    <td>
                        <div class="flex space-x-2">
                            <a href="<?php echo e(route('admin.quizQuestions', $quiz->id)); ?>" class="btn btn-sm bg-yellow-600 hover:bg-yellow-700 text-white rounded-md transition-colors" title="Manage Questions">
                                <i class="fas fa-list-alt"></i>
                            </a>
                            <a href="<?php echo e(route('admin.editQuiz', $quiz->id)); ?>" class="btn btn-sm bg-blue-600 hover:bg-blue-700 text-white rounded-md transition-colors" title="Edit Quiz">
    ...
    <div class="text-center py-8">
        ...
        <a href="<?php echo e(route('admin.createQuiz')); ?>" class="mt-4 inline-block bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded-lg shadow transition duration-200">
            <i class="fas fa-plus mr-2"></i> Add New Quiz
        </a>
    </div>
    <?php endif; ?>
