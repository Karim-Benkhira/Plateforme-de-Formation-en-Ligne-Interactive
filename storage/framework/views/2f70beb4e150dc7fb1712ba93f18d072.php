...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(session('logout_success')): ?>
                        <div class="p-4 bg-blue-900 bg-opacity-40 border border-blue-700 text-blue-300 rounded-lg flex items-start">
                            ...
                            <div>
                                ...
                                <p><?php echo e(session('logout_success')); ?></p>
                            </div>
                        </div>
                    <?php endif; ?>
            ...
            <div class="py-4 px-8 bg-gray-900 border-t border-gray-700">
                <p class="text-center text-gray-400">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-blue-400 hover:text-blue-300 font-medium">
                        Create an account
                    </a>
                </p>
            </div>
...
</html><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/public/Auth/login.blade.php ENDPATH**/ ?>