                    ...
                    <div class="bg-gray-50 p-4 rounded-lg mb-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="font-medium"><?php echo e($quiz->name); ?></p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Course</p>
                                <p class="font-medium"><?php echo e($quiz->course->name); ?></p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Questions</p>
                                <p class="font-medium"><?php echo e($quiz->questions->count()); ?></p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Time Limit</p>
                                <p class="font-medium"><?php echo e($quiz->time_limit ?? 'No limit'); ?></p>
                            </div>
                        </div>
...
<?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/face-recognition/exam-verification.blade.php ENDPATH**/ ?>