...
<body class="bg-gradient-to-br from-blue-50 to-blue-100 min-h-screen flex flex-col text-gray-800">
  <main class="container mx-auto p-4 flex-grow">
    <section class="max-w-xl mx-auto my-12 bg-white rounded-xl shadow-lg p-8">
      ...
      <form action="<?php echo e(route('agent.submitReclamationResponse', $reclamation->id)); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
        <div>
...
</body><?php /**PATH C:\Users\LENOVO\Desktop\BrightPath\resources\views/agent/respondReclamation.blade.php ENDPATH**/ ?>