  ...
  <main class="container mx-auto p-4 flex-grow">
    <section class="my-12 bg-white rounded-xl shadow-lg p-8">
      <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        <h2 class="text-3xl text-blue-600 font-extrabold drop-shadow"><?php echo e($quiz->name); ?> - Questions</h2>
        <a href="<?php echo e(route('admin.createQuestion', $quiz->id)); ?>" class="bg-gradient-to-r from-green-500 to-green-700 hover:from-green-600 hover:to-green-800 text-white font-bold py-2 px-6 rounded-lg shadow transition duration-200">
          Add Question
        </a>
      </div>
          ...
          <tbody>
            <?php $__currentLoopData = $quiz->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr class="<?php echo e($loop->even ? 'bg-blue-50' : ''); ?>">
                <td class="p-3"><?php echo e($question->question); ?></td>
                <td class="p-3 max-w-[300px]"><?php echo e($question->answers); ?></td>
                <td class="p-3">
                    <?php
                ...
                <td class="p-3">
                  <a href="<?php echo e(route('admin.editQuestion', $question->id)); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded transition">Edit</a>
...
</body><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/admin/quizQuestions.blade.php ENDPATH**/ ?>