            ...
            <?php $__currentLoopData = $reclamations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reclamation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr class="<?php echo e($loop->even ? 'bg-blue-50' : ''); ?>">
                ...
                <?php if($reclamation->status !== 'resolved'): ?>
                  <a href="<?php echo e(route('agent.respondReclamation', $reclamation->id)); ?>" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded transition">Respond</a>
                <?php else: ?>
...
</body><?php /**PATH C:\Users\LENOVO\Desktop\BrightPath\resources\views/agent/AgentReclamations.blade.php ENDPATH**/ ?>