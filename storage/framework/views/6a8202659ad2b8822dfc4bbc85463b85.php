...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center mb-8">
        <a href="<?php echo e(route('teacher.quizQuestions', $quizId)); ?>" class="mr-4 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 p-2 rounded-full transition duration-300">
        ...
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white flex items-center">
            ...
            Add Question to <?php echo e($quiz->name); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                ...
                <div class="p-8">
                    <form action="<?php echo e(route('teacher.storeQuestion', $quizId)); ?>" method="POST" class="space-y-8">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="question" id="question" rows="4" placeholder="Enter your question here..." class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 transition duration-200" required><?php echo e(old('question')); ?></textarea>
                        </div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="grid grid-cols-3 gap-4">
                                <div class="relative">
                                    <input type="radio" name="question_type" id="type_multiple_choice" value="multiple_choice" class="peer absolute h-0 w-0 opacity-0" <?php echo e(old('question_type', 'multiple_choice') == 'multiple_choice' ? 'checked' : ''); ?> onchange="toggleQuestionType()">
                                ...
                                <div class="relative">
                                    <input type="radio" name="question_type" id="type_true_false" value="true_false" class="peer absolute h-0 w-0 opacity-0" <?php echo e(old('question_type') == 'true_false' ? 'checked' : ''); ?> onchange="toggleQuestionType()">
                                ...
                                <div class="relative">
                                    <input type="radio" name="question_type" id="type_short_answer" value="short_answer" class="peer absolute h-0 w-0 opacity-0" <?php echo e(old('question_type') == 'short_answer' ? 'checked' : ''); ?> onchange="toggleQuestionType()">
                            ...
                            <input type="hidden" id="question_type_hidden" name="question_type" value="<?php echo e(old('question_type', 'multiple_choice')); ?>">
                        </div>
                        ...
                        <div id="multiple_choice_options" class="p-6 bg-primary-50 dark:bg-primary-900/10 rounded-lg border border-primary-100 dark:border-primary-800">
                            ...
                            <div>
                                ...
                                <textarea name="options" id="options" rows="6" class="w-full px-4 py-3 rounded-lg border border-primary-200 dark:border-primary-700 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 transition duration-200"><?php echo e(old('options')); ?></textarea>
                        ...
                        <div id="true_false_options" class="p-6 bg-primary-50 dark:bg-primary-900/10 rounded-lg border border-primary-100 dark:border-primary-800 hidden">
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-6">
                                    <div class="relative">
                                        <input type="radio" id="true" name="correct_tf" value="true" class="peer absolute h-0 w-0 opacity-0" <?php echo e(old('correct_tf', 'true') == 'true' ? 'checked' : ''); ?>>
                                    ...
                                    <div class="relative">
                                        <input type="radio" id="false" name="correct_tf" value="false" class="peer absolute h-0 w-0 opacity-0" <?php echo e(old('correct_tf') == 'false' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/teacher/createQuestion.blade.php ENDPATH**/ ?>