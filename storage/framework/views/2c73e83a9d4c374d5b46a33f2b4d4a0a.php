...
<!-- Filter Panel -->
<div id="filterPanel" class="bg-gradient-to-br from-gray-900 to-gray-800 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 shadow-xl relative overflow-hidden mb-8 <?php echo e(request('user_id') || request('action') || request('date_from') || request('date_to') ? '' : 'hidden'); ?>">
    ...
    <div class="relative">
        ...
        <form action="<?php echo e(route('admin.activity-logs.index')); ?>" method="GET">
            ...
            <div class="flex flex-wrap justify-end gap-4 pt-6 mt-2">
                <a href="<?php echo e(route('admin.activity-logs.index')); ?>" class="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium rounded-lg transition-all duration-300 flex items-center">
                        ...
                        <tr class="border-b border-gray-800/80 hover:bg-gray-800/50 transition-all duration-200">
                            ...
                            <td class="px-6 py-4">
                                <div>
                                    ...
                                    <span class="badge <?php echo e($badgeClass); ?> mb-2">
