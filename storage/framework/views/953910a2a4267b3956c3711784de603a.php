            ...
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <div class="mt-6 bg-gray-800/50 p-4 rounded-lg border border-gray-700/50 shadow-inner">
                        ...
                        <div class="font-mono text-sm bg-gray-900/50 p-3 rounded border border-gray-700/50 text-blue-300"><?php echo e($secretKey); ?></div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/profile/two-factor.blade.php ENDPATH**/ ?>