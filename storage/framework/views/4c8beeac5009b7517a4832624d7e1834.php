...
<div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl shadow-lg p-6 mb-8">
    <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="mt-4 md:mt-0">
            <a href="<?php echo e(route('admin.createCourse')); ?>" class="bg-white text-blue-600 hover:bg-blue-50 font-semibold py-2 px-4 rounded-lg shadow transition duration-200 inline-flex items-center">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <div class="stats-card">
        ...
        <div>
            ...
            <p class="stats-value"><?php echo e($totalUsers); ?></p>
        </div>
    </div>
    ...
    <div class="stats-card">
        ...
        <div>
            ...
            <p class="stats-value"><?php echo e($activeCourses); ?></p>
        </div>
    </div>
    ...
    <div class="stats-card">
        ...
        <div>
            ...
            <p class="stats-value"><?php echo e($quizzesTaken); ?></p>
        </div>
    </div>
</div>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <?php else: ?>
                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-700 text-white font-bold"><?php echo e($index + 1); ?></span>
                        <?php endif; ?>
                    </td>
                    <td class="font-medium"><?php echo e($user->username); ?></td>
                    <td>
                        <span class="inline-block bg-blue-600 text-white px-3 py-1 rounded-full font-medium text-sm"><?php echo e($user->total_score); ?> pts</span>
                    </td>
                    <td><?php echo e($user->quizzes_count); ?></td>
                </tr>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div class="data-card">
        ...
        <div class="grid grid-cols-2 gap-4">
            <a href="<?php echo e(route('admin.users')); ?>" class="bg-gray-700 hover:bg-gray-600 p-4 rounded-lg flex flex-col items-center justify-center transition-colors">
                <i class="fas fa-users text-blue-400 text-2xl mb-2"></i>
                <span class="text-sm font-medium">Manage Users</span>
            </a>

            <a href="<?php echo e(route('admin.courses')); ?>" class="bg-gray-700 hover:bg-gray-600 p-4 rounded-lg flex flex-col items-center justify-center transition-colors">
                <i class="fas fa-book text-green-400 text-2xl mb-2"></i>
                <span class="text-sm font-medium">Manage Courses</span>
            </a>

            <a href="<?php echo e(route('admin.quizzes')); ?>" class="bg-gray-700 hover:bg-gray-600 p-4 rounded-lg flex flex-col items-center justify-center transition-colors">
                <i class="fas fa-question-circle text-purple-400 text-2xl mb-2"></i>
                <span class="text-sm font-medium">Manage Quizzes</span>
            </a>

            <a href="<?php echo e(route('admin.reclamations')); ?>" class="bg-gray-700 hover:bg-gray-600 p-4 rounded-lg flex flex-col items-center justify-center transition-colors">
    ...
    <div class="data-card">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                ...
                <span class="font-semibold"><?php echo e(App\Models\User::where('role', 'user')->count()); ?></span>
            </div>
            ...
            <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                ...
                <span class="font-semibold"><?php echo e(App\Models\User::where('role', 'teacher')->count()); ?></span>
            </div>
            ...
            <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                ...
                <span class="font-semibold"><?php echo e(App\Models\Category::count()); ?></span>
            </div>
            ...
            <div class="flex items-center justify-between p-3 bg-gray-700 rounded-lg">
                ...
                <span class="font-semibold"><?php echo e(App\Models\Question::count()); ?></span>
            </div>
        </div>
    </div>
</div>
