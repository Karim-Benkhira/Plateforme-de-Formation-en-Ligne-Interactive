            ...
            <div class="mb-8 bg-blue-50 rounded-lg shadow p-6">
              <h3 class="text-lg font-bold mb-4">
                ...
                <?php if($question->type): ?>
                  <span class="ml-2 text-xs text-gray-500 bg-gray-100 px-2 py-1 rounded-full"><?php echo e(ucfirst(str_replace('_', ' ', $question->type))); ?></span>
                <?php endif; ?>
              </h3>
...
</html><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/student/quiz.blade.php ENDPATH**/ ?>