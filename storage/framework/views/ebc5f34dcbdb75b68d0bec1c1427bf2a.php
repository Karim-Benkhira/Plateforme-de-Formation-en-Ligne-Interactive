...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            <a href="<?php echo e(route('teacher.courses.show', $course->id)); ?>" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 transition-colors duration-200 flex items-center mb-2">
                <i class="fas fa-arrow-left mr-2"></i>
                <span>Back to Course</span>
            </a>
            <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Generate AI Quiz</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-1">For course: <span class="font-semibold text-blue-600 dark:text-blue-400"><?php echo e($course->title); ?></span></p>
        </div>
            ...
            <form action="<?php echo e(route('teacher.generate-quiz.store', $course->id)); ?>" method="POST" class="space-y-6" id="quizForm">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" id="name" value="<?php echo e(old('name', $course->title . ' Quiz')); ?>" class="pl-10 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-500 focus:ring-opacity-50" required>
                    </div>
                        ...
                        <div class="relative">
                            ...
                            <select name="num_questions" id="num_questions" class="pl-10 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-500 focus:ring-opacity-50" required>
                                <?php for($i = 5; $i <= 20; $i += 5): ?>
                                    <option value="<?php echo e($i); ?>" <?php echo e(old('num_questions', 5) == $i ? 'selected' : ''); ?>><?php echo e($i); ?> questions</option>
                                <?php endfor; ?>
                            </select>
                        </div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                        ...
                        <div class="relative">
                            ...
                            <select name="difficulty" id="difficulty" class="pl-10 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-500 focus:ring-opacity-50" required>
                                <option value="easy" <?php echo e(old('difficulty', 'easy') == 'easy' ? 'selected' : ''); ?>>Easy</option>
                                <option value="medium" <?php echo e(old('difficulty', 'easy') == 'medium' ? 'selected' : ''); ?>>Medium</option>
                                <option value="hard" <?php echo e(old('difficulty', 'easy') == 'hard' ? 'selected' : ''); ?>>Hard</option>
                            </select>
                        </div>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                        ...
                        <div class="relative">
                            ...
                            <select name="question_type" id="question_type" class="pl-10 w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-500 focus:ring-opacity-50" required>
                                <option value="multiple_choice" <?php echo e(old('question_type', 'multiple_choice') == 'multiple_choice' ? 'selected' : ''); ?>>Multiple Choice</option>
                                <option value="true_false" <?php echo e(old('question_type', 'multiple_choice') == 'true_false' ? 'selected' : ''); ?>>True/False</option>
                                <option value="short_answer" <?php echo e(old('question_type', 'multiple_choice') == 'short_answer' ? 'selected' : ''); ?>>Short Answer</option>
                            </select>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/teacher/generateAIQuiz.blade.php ENDPATH**/ ?>