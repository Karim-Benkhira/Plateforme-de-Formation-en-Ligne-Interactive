...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Generate AI Quiz for <?php echo e($course->title); ?></h1>
        <a href="<?php echo e(route('teacher.courses.show', $course->id)); ?>" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded inline-flex items-center">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
        ...
        <div class="p-6">
            ...
            <form action="<?php echo e(route('teacher.generate-quiz.store', $course->id)); ?>" method="POST" class="space-y-6">
                <?php echo csrf_field(); ?>
                
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Quiz Name</label>
                    <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select name="difficulty" id="difficulty" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                            ...
                            <option value="medium" <?php echo e(old('difficulty') == 'medium' ? 'selected' : ''); ?>>Medium</option>
                    ...
                    <div>
                        ...
                        <select name="question_type" id="question_type" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50" required>
                            ...
                            <option value="short_answer" <?php echo e(old('question_type') == 'short_answer' ? 'selected' : ''); ?>>Short Answer</option>
                        </select>
                    </div>
                </div>
