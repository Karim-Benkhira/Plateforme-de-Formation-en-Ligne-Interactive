...
<link rel="stylesheet" href="<?php echo e(asset('css/course-builder.css')); ?>">
<?php $__env->stopPush(); ?>
...
<div class="welcome-banner bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl shadow-lg p-6 mb-8">
    <div class="flex items-center justify-between">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-3xl font-bold text-white"><?php echo e($course->title); ?></h1>
                <p class="text-blue-100">Course Builder - Add sections and lessons</p>
            </div>
        </div>
        <div class="flex items-center space-x-4">
            <span class="px-3 py-1 rounded-full text-sm font-medium <?php echo e($course->is_published ? 'bg-green-500 text-white' : 'bg-yellow-500 text-black'); ?>">
            ...
            <div class="p-6" id="curriculum-container">
                <?php if($course->sections->count() > 0): ?>
                    <?php $__currentLoopData = $course->sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="section-item mb-6 bg-gray-800 rounded-lg border border-gray-700" data-section-id="<?php echo e($section->id); ?>">
                            <!-- Section Header -->
                            <div class="section-header p-4 bg-gray-700 rounded-t-lg flex items-center justify-between">
                                <div class="flex items-center flex-1">
                                    ...
                                    <div class="flex-1">
                                        <h3 class="text-white font-semibold"><?php echo e($section->title); ?></h3>
                            ...
                            <!-- Section Content -->
                            <div class="section-content p-4" id="section-content-<?php echo e($section->id); ?>">
                                <!-- Lessons -->
                                <div class="lessons-container mb-4" data-section-id="<?php echo e($section->id); ?>">
                                    <?php $__currentLoopData = $section->lessons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lesson): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="lesson-item mb-3 p-3 bg-gray-900 rounded-lg border border-gray-600 flex items-center justify-between" data-lesson-id="<?php echo e($lesson->id); ?>">
                                            <div class="flex items-center flex-1">
                                                <i class="fas fa-grip-vertical text-gray-500 mr-3 cursor-move"></i>
                                                <i class="<?php echo e($lesson->content_type_icon); ?> text-blue-400 mr-3"></i>
                                                <div class="flex-1">
                                                    <h4 class="text-white font-medium"><?php echo e($lesson->title); ?></h4>
                                                    <div class="flex items-center space-x-4 text-sm text-gray-400">
                                                        <span><?php echo e($lesson->content_type_label); ?></span>
                                                        <?php if($lesson->duration): ?>
                                                            <span><?php echo e($lesson->formatted_duration); ?></span>
                                                        <?php endif; ?>
                                                        <?php if($lesson->is_free): ?>
                                                            <span class="text-green-400">Free Preview</span>
                                                        <?php endif; ?>
                                                        <span class="px-2 py-1 rounded text-xs <?php echo e($lesson->is_published ? 'bg-green-600 text-white' : 'bg-yellow-600 text-black'); ?>">
                                            ...
                                            <div class="flex items-center space-x-2">
                                                <button onclick="editLesson(<?php echo e($section->id); ?>, <?php echo e($lesson->id); ?>)"
                                                    class="text-blue-400 hover:text-blue-300 transition-colors">
                                                    <i class="fas fa-edit"></i>
                                                </button>
                                                <button onclick="toggleLessonPublish(<?php echo e($section->id); ?>, <?php echo e($lesson->id); ?>)"
                                                    class="text-yellow-400 hover:text-yellow-300 transition-colors">
                                                    <i class="fas <?php echo e($lesson->is_published ? 'fa-eye-slash' : 'fa-eye'); ?>"></i>
                                                </button>
                                                <button onclick="deleteLesson(<?php echo e($section->id); ?>, <?php echo e($lesson->id); ?>)"
                                                    class="text-red-400 hover:text-red-300 transition-colors">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </div>
                                ...
                                <!-- Add Lesson Button -->
                                <button onclick="addLesson(<?php echo e($section->id); ?>)"
        ...
        <div class="bg-gray-900 rounded-xl shadow-lg overflow-hidden mb-6">
            ...
            <div class="p-4 space-y-4">
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-white font-semibold stats-sections"><?php echo e($course->sections->count()); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-400">Lessons</span>
                    <span class="text-white font-semibold stats-lessons"><?php echo e($course->total_lessons); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-400">Duration</span>
                    <span class="text-white font-semibold stats-duration"><?php echo e($course->formatted_total_duration); ?></span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-400">Published</span>
                    <span class="text-white font-semibold stats-published"><?php echo e($course->published_lessons_count); ?></span>
                </div>
                <div class="mt-4 pt-4 border-t border-gray-700">
                    <div class="flex justify-between items-center mb-2">
                        <span class="text-gray-400 text-sm">Course Progress</span>
                        <span class="text-white text-sm font-semibold">
                            <?php echo e($course->sections->count() > 0 ? round(($course->published_lessons_count / max($course->total_lessons, 1)) * 100) : 0); ?>%
                        </span>
                    </div>
                    <div class="w-full bg-gray-700 rounded-full h-2">
                        <div class="bg-gradient-to-r from-blue-500 to-green-500 h-2 rounded-full transition-all duration-300"
                             style="width: <?php echo e($course->sections->count() > 0 ? round(($course->published_lessons_count / max($course->total_lessons, 1)) * 100) : 0); ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gray-900 rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="p-4 space-y-3">
                ...
                <button onclick="toggleCoursePublish()" class="w-full <?php echo e($course->is_published ? 'bg-yellow-600 hover:bg-yellow-700' : 'bg-purple-600 hover:bg-purple-700'); ?> text-white py-2 px-4 rounded-lg transition-all">
                    ...
                    <?php echo e($course->is_published ? 'Unpublish' : 'Publish'); ?> Course
                </button>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('teacher.course-builder.modals.section-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php echo $__env->make('teacher.course-builder.modals.lesson-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
var currentCourseId = <?php echo e($course->id); ?>;
...
<script src="<?php echo e(asset('js/course-builder.js')); ?>"></script>
<script>
...
<?php echo $__env->make('layouts.teacher', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/teacher/course-builder/edit.blade.php ENDPATH**/ ?>