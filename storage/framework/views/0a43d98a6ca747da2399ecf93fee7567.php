...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Student Dashboard'); ?> - BrightPath</title>

    <!-- Tailwind CSS -->
    <script src="https://cdn.tailwindcss.com"></script>
    <link href="<?php echo e(asset('css/teacher-dashboard.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/student-dashboard.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('css/student-courses.css')); ?>" rel="stylesheet">
    <script>
        tailwind.config = {
            darkMode: 'class',
            theme: {
        ...
        <aside class="dashboard-sidebar" :class="{ 'collapsed': !sidebarOpen }">
            ...
            <div class="mt-6">
                <nav>
                    ...
                    <a href="<?php echo e(route('student.courses')); ?>" class="sidebar-link <?php echo e(request()->routeIs('student.courses') ? 'active' : ''); ?>">
                        <i class="fas fa-book"></i>
                        <span x-show="sidebarOpen">All Courses</span>
                    </a>
                    <a href="<?php echo e(route('student.myCourses')); ?>" class="sidebar-link <?php echo e(request()->routeIs('student.myCourses') ? 'active' : ''); ?>">
                        <i class="fas fa-graduation-cap"></i>
                        <span x-show="sidebarOpen">My Courses</span>
                    </a>
                    <a href="<?php echo e(route('student.ai.practice')); ?>" class="sidebar-link <?php echo e(request()->routeIs('student.ai.*') ? 'active' : ''); ?>">
                        <i class="fas fa-robot"></i>
                        <span x-show="sidebarOpen">AI Practice</span>
                    </a>
                    <a href="<?php echo e(route('student.progress')); ?>" class="sidebar-link <?php echo e(request()->routeIs('student.progress') ? 'active' : ''); ?>">
                        <i class="fas fa-chart-line"></i>
                        <span x-show="sidebarOpen">My Progress</span>
                    </a>
                    <a href="<?php echo e(route('student.achievements')); ?>" class="sidebar-link <?php echo e(request()->routeIs('student.achievements') ? 'active' : ''); ?>">
                        <i class="fas fa-trophy"></i>
                        <span x-show="sidebarOpen">Achievements</span>
                    </a>
                    <a href="<?php echo e(route('student.leaderboard')); ?>" class="sidebar-link <?php echo e(request()->routeIs('student.leaderboard') ? 'active' : ''); ?>">
                        <i class="fas fa-medal"></i>
                        <span x-show="sidebarOpen">Leaderboard</span>
                    </a>
                    <a href="<?php echo e(route('student.support')); ?>" class="sidebar-link <?php echo e(request()->routeIs('student.support') ? 'active' : ''); ?>">
            ...
            <header class="bg-gray-800 shadow-md">
                <div class="flex items-center justify-between px-6 py-4">
                    <div class="flex items-center">
                        <h1 class="text-xl font-semibold text-white"><?php echo $__env->yieldContent('title', 'Student Dashboard'); ?></h1>
                    </div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="relative" x-data="{ open: false }">
                            ...
                            <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-56 bg-gray-800 rounded-lg shadow-xl py-2 border border-gray-700 z-50">
                                ...
                                <a href="<?php echo e(route('student.profile')); ?>" class="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors flex items-center">
...
<?php /**PATH /var/www/resources/views/layouts/student.blade.php ENDPATH**/ ?>