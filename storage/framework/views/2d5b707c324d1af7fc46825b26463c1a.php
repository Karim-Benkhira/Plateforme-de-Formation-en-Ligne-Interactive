                    ...
                    <tr class="course-row border-b border-gray-800/80 hover:bg-gray-800/50 transition-all duration-200">
                        <td class="px-4 py-4">
                            <div class="flex items-center">
                                ...
                                <a href="<?php echo e(route('admin.showCourse', $course->id)); ?>" class="hover:text-yellow-400 font-medium transition-colors group">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/admin/courses.blade.php ENDPATH**/ ?>