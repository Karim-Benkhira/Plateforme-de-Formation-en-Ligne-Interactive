...
<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8" id="coursesGrid">
    <?php if(count($courses) > 0): ?>
        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="course-card overflow-hidden" data-category="<?php echo e($course->category_id ?? 'all'); ?>">
                <div class="relative">
                    <?php if($course->image): ?>
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/student/courses.blade.php ENDPATH**/ ?>