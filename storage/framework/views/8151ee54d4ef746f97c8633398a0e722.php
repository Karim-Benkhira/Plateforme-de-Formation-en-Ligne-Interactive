...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <!-- Support Guidelines -->
    <div class="data-card p-6 mb-8 lg:col-span-1">
        ...
        <div class="bg-gray-800 bg-opacity-50 rounded-lg p-4">
            <div class="flex items-center mb-3">
                ...
                <h3 class="text-white font-semibold">Common Questions</h3>
            </div>
            <div class="space-y-3">
                <div class="border-b border-gray-700 pb-3">
                    <button class="flex items-center justify-between w-full text-left text-gray-300 hover:text-white">
