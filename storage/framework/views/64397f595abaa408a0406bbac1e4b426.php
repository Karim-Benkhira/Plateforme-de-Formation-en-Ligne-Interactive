...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center mb-6">
        <a href="<?php echo e(route('teacher.analytics')); ?>" class="mr-4 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
            <i class="fas fa-arrow-left"></i>
        </a>
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Analytics: <?php echo e($course->title); ?></h1>
    </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-purple-50 dark:bg-gray-700 p-4 rounded-lg">
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-white"><?php echo e(isset($quizPerformance['average_completion']) ? $quizPerformance['average_completion'] . '%' : 'N/A'); ?></p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
                                    ...
                                    <?php $__currentLoopData = $quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($quiz->questions->count()); ?> questions</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900 dark:text-white">
                                                    <?php echo e(isset($quizPerformance[$quiz->id]) ? $quizPerformance[$quiz->id]['average_score'] . '%' : 'N/A'); ?>

                                                </div>
                                                <div class="w-full bg-gray-200 rounded-full h-2.5 mt-1">
                                                    <div class="bg-blue-600 h-2.5 rounded-full" style="width: <?php echo e(isset($quizPerformance[$quiz->id]) ? $quizPerformance[$quiz->id]['average_score'] : 0); ?>%"></div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="<?php echo e(route('teacher.quizQuestions', $quiz->id)); ?>" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                                                    View Details
                                                </a>
                                            </td>
                                        </tr>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <?php if(isset($quizPerformance['questions']) && count($quizPerformance['questions']) > 0): ?>
                        <div class="space-y-6">
                            <?php $__currentLoopData = $quizPerformance['questions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php $__currentLoopData = $question['answers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $answer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div>
                                                    <div class="flex justify-between text-sm mb-1">
                                                        <span class="<?php echo e($answer['is_correct'] ? 'text-green-600 font-medium' : 'text-gray-600 dark:text-gray-400'); ?>">
                                                            <?php echo e($answer['text']); ?> <?php echo e($answer['is_correct'] ? '(Correct)' : ''); ?>

                                                        </span>
                                                        <span><?php echo e($answer['percentage']); ?>%</span>
                                                    </div>
                                                    <div class="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                                                        <div class="<?php echo e($answer['is_correct'] ? 'bg-green-500' : 'bg-blue-500'); ?> h-2 rounded-full" style="width: <?php echo e($answer['percentage']); ?>%"></div>
                                                    </div>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <?php if(isset($quizPerformance['students']) && count($quizPerformance['students']) > 0): ?>
                        <div class="space-y-4">
                            <?php $__currentLoopData = $quizPerformance['students']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 rounded-full bg-gray-200 dark:bg-gray-600 flex items-center justify-center">
                                            <span class="text-gray-700 dark:text-gray-300 font-bold"><?php echo e(substr($student['name'], 0, 1)); ?></span>
                                        </div>
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($student['name']); ?></div>
                                            <div class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($student['quizzes_taken']); ?> quizzes taken</div>
                                        </div>
                                    </div>
                                    <div>
                                        <div class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($student['average_score']); ?>%</div>
                                        <div class="w-24 bg-gray-200 rounded-full h-1.5 mt-1">
                                            <div class="bg-yellow-500 h-1.5 rounded-full" style="width: <?php echo e($student['average_score']); ?>%"></div>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/teacher/courseAnalytics.blade.php ENDPATH**/ ?>