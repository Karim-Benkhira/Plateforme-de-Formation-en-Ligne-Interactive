...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white flex items-center">
            <span class="bg-blue-100 dark:bg-blue-900 p-2 rounded-full mr-3">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-8">
            <form action="<?php echo e(route('teacher.quizzes.store')); ?>" method="POST" class="space-y-8">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" placeholder="Enter quiz name" class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-200" required>
                        </div>

                        <div>
                            <label for="course_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Select Course</label>
                            <select name="course_id" id="course_id" class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-200" required>
                ...
                <div class="mb-8">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">
                        <i class="fas fa-cog mr-2 text-blue-500"></i>Quiz Settings
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                        <div class="bg-gray-50 dark:bg-gray-750 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                            <label for="duration" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                <i class="fas fa-clock text-indigo-500 mr-2"></i>Duration (minutes)
                            </label>
                            <input type="number" name="duration" id="duration" min="1" max="180" value="30" class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-200" required>
                        </div>

                        <div class="bg-gray-50 dark:bg-gray-750 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                            <label for="passing_score" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                <i class="fas fa-percentage text-green-500 mr-2"></i>Passing Score (%)
                            </label>
                            <input type="number" name="passing_score" id="passing_score" min="1" max="100" value="70" class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-200" required>
                        </div>

                        <div class="bg-gray-50 dark:bg-gray-750 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                            <label for="attempts_allowed" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                <i class="fas fa-redo text-orange-500 mr-2"></i>Attempts Allowed
                            </label>
                            <input type="number" name="attempts_allowed" id="attempts_allowed" min="1" max="10" value="2" class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-200" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea name="description" id="description" rows="4" placeholder="Enter quiz description" class="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 transition duration-200"></textarea>
                ...
                <div class="mb-8">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">
                        <i class="fas fa-sliders-h mr-2 text-blue-500"></i>Additional Options
                    </h3>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gray-50 dark:bg-gray-750 p-4 rounded-lg border border-gray-200 dark:border-gray-700 flex items-center">
                            <input type="checkbox" name="is_published" id="is_published" class="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded transition duration-200">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-750 p-4 rounded-lg border border-gray-200 dark:border-gray-700 flex items-center">
                            <input type="checkbox" name="requires_face_verification" id="requires_face_verification" class="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded transition duration-200">
                ...
                <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                    <div class="flex justify-end">
                        <button type="button" onclick="window.location.href='<?php echo e(route('teacher.quizzes')); ?>'" class="bg-white dark:bg-gray-700 py-3 px-6 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300">
                            Cancel
                        </button>
    ...
    <div class="mt-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700">
        ...
        <div class="p-8">
            <ul class="space-y-4 text-gray-700 dark:text-gray-300">
                <li class="flex items-start bg-purple-50 dark:bg-purple-900/20 p-3 rounded-lg">
                ...
                <li class="flex items-start bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
                ...
                <li class="flex items-start bg-green-50 dark:bg-green-900/20 p-3 rounded-lg">
                ...
                <li class="flex items-start bg-indigo-50 dark:bg-indigo-900/20 p-3 rounded-lg">
                    <div class="bg-indigo-100 dark:bg-indigo-800 p-2 rounded-full mr-3">
                ...
                <li class="flex items-start bg-red-50 dark:bg-red-900/20 p-3 rounded-lg">
