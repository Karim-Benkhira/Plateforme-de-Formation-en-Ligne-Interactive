                            ...
                            <button @click="open = !open" class="flex items-center space-x-2 focus:outline-none">
                                <span class="inline-flex items-center justify-center h-10 w-10 rounded-full overflow-hidden border-2 border-blue-500 shadow-md">
                                    <?php if(Auth::user()->profile_image): ?>
                                        <img src="<?php echo e(asset('storage/profile_images/' . Auth::user()->profile_image)); ?>" alt="<?php echo e(Auth::user()->username); ?>" class="h-full w-full object-cover">
                                    <?php else: ?>
...
<?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/layouts/student.blade.php ENDPATH**/ ?>