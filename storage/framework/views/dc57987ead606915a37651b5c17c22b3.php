<?php $__env->startSection('title', 'Explore Courses | BrightPath'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <div class="bg-gray-800 rounded-lg p-5 border-l-4 border-blue-500 shadow-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-3xl font-bold text-white"><?php echo e(count($courses ?? [])); ?></div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6" id="coursesGrid">
                <?php if(isset($courses) && count($courses) > 0): ?>
                    <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-gray-800 rounded-lg overflow-hidden shadow-lg transition-all hover:shadow-blue-900/30 hover:shadow-xl course-card" data-category="<?php echo e($course->category_id ?? 'all'); ?>">
                            <div class="relative">
                                <?php if($course->image): ?>
                                ...
                                <div class="absolute top-3 right-3 bg-red-600 text-white text-xs font-bold px-2 py-1 rounded-full">
                                    <?php echo e($course->category->name ?? 'Red Team'); ?>

                                </div>
                            </div>

                            <div class="p-4">
                                <h3 class="text-lg font-bold text-white mb-2 line-clamp-1"><?php echo e($course->title ?? $course->name); ?></h3>
                                ...
                                <div class="flex justify-between items-center mb-3">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-gray-400 text-sm"><?php echo e($course->teacher->username ?? 'Teacher1'); ?></span>
                                    </div>
                                    <div class="flex items-center">
                                        <span class="text-gray-400 text-sm"><?php echo e($course->students_count ?? rand(50, 99)); ?> <i class="fas fa-users text-gray-500 ml-1"></i></span>
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-white font-bold"><?php echo e($course->score ?? '100'); ?></span>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/public/courses.blade.php ENDPATH**/ ?>