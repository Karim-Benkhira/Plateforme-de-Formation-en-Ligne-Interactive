...
<div class="bg-gradient-to-br from-gray-900 to-gray-800 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 shadow-xl relative overflow-hidden max-w-3xl mx-auto">
    ...
    <div class="relative">
        ...
        <!-- Form Content -->
        <form action="<?php echo e(route('admin.updateQuiz', $quiz->id)); ?>" method="POST" class="space-y-8">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700/50">
                ...
                <div class="relative input-focus-effect">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $quiz->name)); ?>" required
                ...
                <div class="relative input-focus-effect">
                    ...
                    <select name="course_id" id="course_id" required
                        ...
                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($course->id); ?>" <?php echo e((old('course_id', $quiz->course_id) == $course->id) ? 'selected' : ''); ?>>
            ...
            <div class="flex flex-col sm:flex-row justify-end gap-4 pt-4 border-t border-gray-700/50">
                <a href="<?php echo e(route('admin.quizzes')); ?>" class="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium rounded-lg transition-all duration-300 flex items-center justify-center">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/admin/editQuiz.blade.php ENDPATH**/ ?>