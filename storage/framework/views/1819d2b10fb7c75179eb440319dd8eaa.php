  ...
  <main class="container mx-auto p-4 flex-grow">
    <section class="my-12 bg-white p-10 rounded-xl shadow-lg w-[70%] mx-auto">
      ...
      <div class="mt-10 text-center flex flex-col md:flex-row justify-between gap-4">
        <a href="<?php echo e(route('student.courses')); ?>" class="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded-lg transition duration-200">
          ← Back to Courses
        </a>
        <?php if($course->quizzes->isNotEmpty()): ?>
          <div class="flex space-x-4">
            <a href="<?php echo e(route('student.quiz', $course->quizzes[0]->id)); ?>" class="inline-block bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-6 rounded-lg transition duration-200">
              Take Quiz →
            </a>
            <a href="<?php echo e(route('student.secureExam', $course->quizzes[0]->id)); ?>" class="inline-block bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-6 rounded-lg transition duration-200 flex items-center">
...
<?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/student/courseDetails.blade.php ENDPATH**/ ?>