<?php $__env->startSection('title', 'Face Verification - ' . $quiz->name); ?>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="text-center mb-8">
            ...
            <div class="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-6 py-2 text-white">
                ...
                <span class="font-semibold"><?php echo e($quiz->name); ?></span>
            </div>
        </div>
                        ...
                        <div class="bg-gray-900/50 rounded-xl p-6 border border-gray-700/50">
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="text-white font-medium"><?php echo e($quiz->duration); ?> minutes</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-400">Passing Score:</span>
                                    <span class="text-white font-medium"><?php echo e($quiz->passing_score); ?>%</span>
                                </div>
                                <div class="flex items-center justify-between">
                                    <span class="text-gray-400">Questions:</span>
                                    <span class="text-white font-medium"><?php echo e($quiz->questions->count()); ?></span>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function verifyIdentity() {
        try {
            ...
            const response = await fetch('<?php echo e(route("face-verification.verify-exam")); ?>', {
                method: 'POST',
                headers: {
    ...
    function continueToExam() {
        if (verificationComplete) {
            window.location.href = '<?php echo e(route("student.quiz", $quiz->id)); ?>';
        }
    }
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/student/exam-verification.blade.php ENDPATH**/ ?>