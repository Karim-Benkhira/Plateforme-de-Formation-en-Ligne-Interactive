                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="bg-gray-700 p-4 rounded-lg">
                        <div class="flex items-center">
                            <input type="checkbox" name="is_published" id="is_published" value="1" class="rounded border-gray-700 text-purple-600 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-500 focus:ring-opacity-50" <?php echo e($quiz->is_published ? 'checked' : ''); ?>>
                    ...
                    <div class="bg-gray-700 p-4 rounded-lg">
                        <div class="flex items-center">
                            <input type="checkbox" name="requires_face_verification" id="requires_face_verification" value="1" class="rounded border-gray-700 text-purple-600 shadow-sm focus:border-purple-500 focus:ring focus:ring-purple-500 focus:ring-opacity-50" <?php echo e($quiz->requires_face_verification ? 'checked' : ''); ?>>
