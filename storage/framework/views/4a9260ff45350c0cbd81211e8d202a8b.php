...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-3xl mx-auto">
        <div class="mb-6">
            <a href="<?php echo e(route('profile.edit')); ?>" class="inline-flex items-center text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4 flex-1">
                                <div class="flex justify-between">
                                    <h3 class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($log->action); ?></h3>
                                    <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($log->created_at->diffForHumans()); ?></span>
                                </div>
                                <?php if($log->description): ?>
                                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400"><?php echo e($log->description); ?></p>
                                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/profile/activity.blade.php ENDPATH**/ ?>