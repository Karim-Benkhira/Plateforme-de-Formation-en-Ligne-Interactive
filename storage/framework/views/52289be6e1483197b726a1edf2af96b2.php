...
<div class="bg-gradient-to-br from-gray-900 to-gray-800 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 shadow-xl relative overflow-hidden mb-6">
    ...
    <div class="relative">
        <form action="<?php echo e(route('admin.updateCourse', $course->id)); ?>" enctype="multipart/form-data" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-8">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" name="title" id="title" value="<?php echo e($course->name); ?>" required
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="number" name="score" id="score" value="<?php echo e($course->score); ?>" required
                                class="w-full pl-10 p-3 bg-gray-800/80 border border-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200" />
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="relative">
                        <textarea name="description" id="description" rows="4" required
                            class="w-full p-3 bg-gray-800/80 border border-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"><?php echo e($course->description); ?></textarea>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="bg-gray-800/50 p-3 rounded-lg border border-gray-700/50 space-y-2">
                        <label class="flex items-center p-2 rounded-md hover:bg-gray-700/50 transition-colors cursor-pointer">
                            <input type="radio" name="level" value="beginner" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-700 bg-gray-700" <?php echo e($course->level == 'beginner' ? 'checked' : ''); ?>>
                            <span class="ml-2 text-gray-300">Beginner</span>
                        </label>
                        <label class="flex items-center p-2 rounded-md hover:bg-gray-700/50 transition-colors cursor-pointer">
                            <input type="radio" name="level" value="intermediate" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-700 bg-gray-700" <?php echo e($course->level == 'intermediate' ? 'checked' : ''); ?>>
                            <span class="ml-2 text-gray-300">Intermediate</span>
                        </label>
                        <label class="flex items-center p-2 rounded-md hover:bg-gray-700/50 transition-colors cursor-pointer">
                            <input type="radio" name="level" value="advanced" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-700 bg-gray-700" <?php echo e($course->level == 'advanced' ? 'checked' : ''); ?>>
                ...
                <div class="mt-6">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_published" id="is_published" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-700 bg-gray-700 rounded" <?php echo e($course->is_published ? 'checked' : ''); ?>>
            ...
            <div class="mb-8">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative group">
                        ...
                        <select name="content_type" id="content_type" required onchange="toggleContentInputs()"
                            ...
                            <option value="text" <?php echo e($course->contents->first()->type === 'text' ? 'selected' : ''); ?>>Text Content</option>
                            <option value="pdf" <?php echo e($course->contents->first()->type === 'pdf' ? 'selected' : ''); ?>>PDF Document</option>
                ...
                <!-- Text Content Input -->
                <div id="text_input" class="<?php echo e($course->contents->first()->type === 'text' ? '' : 'hidden'); ?> mb-6">
                    <label for="content" class="block text-gray-300 font-medium mb-2">Text Content</label>
                    <div class="relative">
                        <textarea name="content" id="content" rows="8"
                            class="w-full p-3 bg-gray-800/80 border border-gray-700 rounded-lg text-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200"><?php echo e($course->contents->first()->type === 'text' ? $course->contents->first()->content : ''); ?></textarea>
                    </div>
                </div>

                <!-- PDF Input -->
                <div id="pdf_input" class="<?php echo e($course->contents->first()->type === 'pdf' ? '' : 'hidden'); ?> mb-6">
                    ...
                    <?php if($course->contents->first()->type === 'pdf'): ?>
                        <div class="mt-3 p-3 bg-gray-800/50 rounded-lg border border-gray-700/50 flex items-center">
                            ...
                            <a href="<?php echo e(asset('storage/' . $course->contents->first()->file)); ?>" target="_blank" class="ml-2 text-blue-400 hover:text-blue-300 underline">
                                View PDF
                            </a>
                        </div>
                    <?php endif; ?>
                ...
                <!-- YouTube Input -->
                <div id="youtube_input" class="<?php echo e($course->contents->first()->type === 'youtube' ? '' : 'hidden'); ?> mb-6">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="youtube_link" id="youtube_link" value="<?php echo e($course->contents->first()->type === 'youtube' ? $course->contents->first()->file : ''); ?>"
                ...
                <?php if($course->contents->first()->type === 'pdf'): ?>
                    <div id="pdf_preview" class="mt-6 bg-gray-800/50 rounded-lg border border-gray-700/50 p-4 content-preview">
                        ...
                        <iframe class="w-full h-[500px] rounded-lg border border-gray-700/50" src="<?php echo e(asset('storage/' . $course->contents->first()->file)); ?>" frameborder="0"></iframe>
                    </div>
                <?php elseif($course->contents->first()->type === 'youtube'): ?>
                    <div id="youtube_preview_container" class="mt-6 bg-gray-800/50 rounded-lg border border-gray-700/50 p-4 content-preview">
                        ...
                        ?>
                        <iframe id="youtube_preview_iframe" class="w-full h-[500px] rounded-lg border border-gray-700/50" src="<?php echo e($embedUrl); ?>" frameborder="0" allowfullscreen></iframe>
                    </div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/karim/Plateforme-de-Formation-en-Ligne-Interactive/resources/views/admin/editCourse-new.blade.php ENDPATH**/ ?>